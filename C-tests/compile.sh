...
# for rv32im
riscv32-unknown-elf-gcc -march=rv32im -mabi=ilp32 -nostdlib -Wall -O3 -S $1.c -o $1.s
riscv32-unknown-elf-as  -march=rv32im -mabi=ilp32  $1.s -o $1.o
riscv32-unknown-elf-ld  -m elf32lriscv -T link.ld $1.o -o $1.elf
riscv32-unknown-elf-objcopy $1.elf -O binary $1.bin

# for rv32i only
# riscv32-unknown-elf-gcc -march=rv32i -mabi=ilp32 -nostdlib -Wall -O0 -S $1.c -o $1.s
