...
* used are getchar, putchar and the EOF value. */
                    ...
                    // THE BELOW LINE HAS BEEN COMMENTED OUT BY ARTHUR FERREIRA
                    // #include <stdio.h>
...
// START OF CODE MODIFIED BY ARTHUR FERREIRA
...
* read from a serial line. */
int llkey() {
    char *RX = (char*) 0x0f000000;
    if (*initscript_pos)
      return *(initscript_pos++);
    return *RX;
}
// END OF CODE MODIFIED BY ARTHUR FERREIRA
